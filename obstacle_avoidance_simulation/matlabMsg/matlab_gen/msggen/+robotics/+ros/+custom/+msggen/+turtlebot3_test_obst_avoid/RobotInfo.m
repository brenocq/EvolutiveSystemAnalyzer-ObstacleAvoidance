classdef RobotInfo < robotics.ros.Message
    %RobotInfo MATLAB implementation of turtlebot3_test_obst_avoid/RobotInfo
    ...
    properties (Constant)
        MessageType = 'turtlebot3_test_obst_avoid/RobotInfo' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.turtlebot3_test_obst_avoid.RobotInfo.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.turtlebot3_test_obst_avoid.RobotInfo;
            obj.reload(strObj);
        end
    end
end
