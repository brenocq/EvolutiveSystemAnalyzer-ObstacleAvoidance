classdef EvolutiveSystemConfiguration < robotics.ros.Message
    %EvolutiveSystemConfiguration MATLAB implementation of turtlebot3_test_obst_avoid/EvolutiveSystemConfiguration
    ...
    properties (Constant)
        MessageType = 'turtlebot3_test_obst_avoid/EvolutiveSystemConfiguration' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.turtlebot3_test_obst_avoid.EvolutiveSystemConfiguration.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.turtlebot3_test_obst_avoid.EvolutiveSystemConfiguration;
            obj.reload(strObj);
        end
    end
end
